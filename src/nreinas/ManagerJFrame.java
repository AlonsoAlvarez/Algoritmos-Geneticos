...
public class ManagerJFrame extends javax.swing.JFrame {
    ...
    GeneticoNReinas gen = new GeneticoNReinas();
    ...
    public ManagerJFrame() {
        initComponents();
       conf = new Configuracion(1000000, 100, 0.00001, 0.2,new Seleccion.TipoSeleccion[]{Seleccion.TipoSeleccion.RANDOM,Seleccion.TipoSeleccion.TORNEO},1000);
       //GeneticoNReinas gen = new GeneticoNReinas(conf);
       gen.setManager(conf);
       Thread hilo = new Thread(gen);
       hilo.start();
       this.jLabel1.setText("generaciones: "+gen.getNumG()+"\n poblacion: "+gen.getTamP()+"\n muta: "+gen.getpMuta());
        System.out.println();
    }
