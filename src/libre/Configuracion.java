...
public class Configuracion {
   ...
   public Individuo aplicarSeleccion(Poblacion pobActual, int i,  ArrayList<Patron> au2){
       Individuo aux = null; 
       // evaluar i
       switch(getTipoSeleccion()[i]){
           case RANDOM:{
             aux = Seleccion.seleccionAleatoria(pobActual,au2);
           break;}
           case TORNEO:{
             aux = Seleccion.seleccionTorneo(pobActual,au2);
           break;}   
           default: aux = null;
   ...
   return aux;
    ...
    public String toString() {
        return "Configuracion{" + "numGeneraciones=" + numGeneraciones + ", tamPoblacion=" + tamPoblacion + ", probMuta=" + probMuta + '}';
    }
